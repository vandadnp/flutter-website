...
<!-- <?code-excerpt "examples/get-started/flutter-for/ios
_devs_swiftui/rendering_text_swiftui/rendering_text_swiftui/ContentView.swift (SimpleText)"?> -->
```swift
...
<!-- <?code-excerpt "examples/get-started/flutter-for/ios
_devs_swiftui/rendering-text-swiftui/rendering_text_flutter/lib/main.dart (SimpleText)"?> -->
```dart
